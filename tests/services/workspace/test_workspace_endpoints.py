...
class TestWorkspaceManagement:
    ...
    def test_create_workspace_unauthorized(
        self, workspace_service_url, workspace_api_path, workspace_data, admin_auth_headers
    ):
    ...
    def test_create_workspace_forbidden(
        self, workspace_service_url, workspace_api_path, user_auth_headers, 
        workspace_data
    ):
...
class TestTariffs:
    ...
    def test_create_tariff_success(
        self, workspace_service_url, workspace_api_path, admin_auth_headers, unique_timestamp
    ):
    ...
    def test_update_tariff_forbidden(
        self, workspace_service_url, workspace_api_path, user_auth_headers, tariff_id
    ):
