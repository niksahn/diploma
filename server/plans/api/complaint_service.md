...
> Примечание по данным: идентификаторы автора и администратора приходят из Gateway через заголовки и сохраняются как числа без внешних ключей на другие сервисы, чтобы жалобы можно было создавать и обрабатывать даже при отсутствии записей о пользователях/администраторах в локальной БД.
