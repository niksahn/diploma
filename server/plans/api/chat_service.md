...
**Validation**:
- `name`: для личного чата (type=1) можно опустить, для групп/каналов (type=2/3) обязателен 3-100 символов
...
```json
{
  "tasks": [
    {
      "attached_at": "2024-01-01T10:00:00Z",
      "creator": 1,
