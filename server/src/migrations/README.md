...
### 000002_create_complaints_tables
**Дата:** 2025-12-06  
**Описание:** Добавляет таблицы `complaints` и `complaint_status_history` со статусами, временными метками и индексацией по автору/статусу.
